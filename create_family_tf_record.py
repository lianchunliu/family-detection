...
Example usage:
    python create_family_tf_record.py \
...
def dict_to_tf_example(data,
  ...
  """
  full_path = os.path.join(FLAGS.annotations_dir, data['filename'])
...
def main(_):
  ...
  writer = tf.python_io.TFRecordWriter(os.path.join(FLAGS.output_path,'family_' + FLAGS.set + '.tfrecord'))

  label_map_dict = label_map_util.get_label_map_dict(FLAGS.label_map_path)

  if data_dir:
    examples_path = os.path.join(data_dir, 
                                 'family_' + FLAGS.set + '.txt')
